    ...
    <>
      ...
      <section className="contact-hero">
        ...
        <div className="contact-container contact-hero-grid">
          ...
          {/* HERO LEFT */}
          <div className="contact-hero-content contact-hero-slide-left">
            ...
            <div className="clients-hero-bottom contact-hero-bottom-content">
          ...
          {/* HERO RIGHT */}
          <div
            className="contact-hero-visual contact-hero-slide-right"
            aria-hidden="true"
          >
        ...
        <div className="contact-hero-bottom contact-hero-bottom-reveal">
          <span>CONNECT</span>
      ...
      <section className="contact-intro">
        ...
        <div className="contact-container">
          ...
          <div className="contact-intro-grid">
            ...
            <div className="contact-intro-right contact-scroll-right">
      ...
      <section className="contact-details">
        ...
        <div className="contact-container">
          ...
          <div className="contact-details-heading contact-scroll-up">
          ...
          <div className="contact-details-grid">
            ...
            {/* INDIA */}
            <div className="contact-info-card contact-card-reveal contact-card-delay-1">
            ...
            {/* UAE */}
            <div className="contact-info-card contact-card-reveal contact-card-delay-2">
            ...
            {/* SALES & SUPPORT */}
            <div className="contact-info-card contact-info-card-highlight contact-card-reveal contact-card-delay-3">
      ...
      <section className="contact-form-section">
        ...
        <div className="contact-container">
          ...
          <div className="contact-form-layout">
            ...
            {/* LEFT IMAGE */}
            <div className="contact-form-visual contact-form-slide-left">
            ...
            {/* RIGHT FORM */}
            <div className="contact-form-wrapper contact-form-slide-right">
