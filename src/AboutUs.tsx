...
const AboutUs: React.FC<AboutUsProps> = ({ setShow }) => {
  ...
  <section className="about-hero">
    ...
    <div className="about-container about-hero-inner">
      ...
      {/* LEFT CONTENT */}
      <div className="about-hero-content about-hero-slide-left">
      ...
      {/* RIGHT VISUAL */}
      <div className="about-hero-visual about-hero-slide-right">
  ...
  <section className="about-intro">
    ...
    <div className="about-container">
      ...
      <div className="about-section-heading about-scroll-left">
      ...
      <div className="about-main-grid">
        ...
        {/* LEFT CONTENT */}
        <div className="about-content about-content-slide-left">
          ...
          <div className="about-values">
            ...
            <div className="about-values-grid">
              ...
              <div className="about-value-card about-value-reveal about-value-delay-1">
              ...
              <div className="about-value-card about-value-reveal about-value-delay-2">
                <div className="about-value-number">
                  02
                </div>
              ...
              <div className="about-value-card about-value-reveal about-value-delay-3">
                <div className="about-value-number">
                  03
                </div>
              ...
              <div className="about-value-card about-value-reveal about-value-delay-4">
                <div className="about-value-number">
                  04
                </div>
  ...
  <section className="about-experience">
    ...
    <div className="about-container">
      ...
      <div className="about-experience-grid">
        ...
        <div className="about-experience-item about-experience-reveal about-experience-delay-2">
          <strong>ERP</strong>
          <span>Industry Solutions</span>
        </div>

        <div className="about-experience-item about-experience-reveal about-experience-delay-3">
          <strong>360°</strong>
          <span>Technology Services</span>
        </div>

        <div className="about-experience-item about-experience-reveal about-experience-delay-4">
          <strong>24/7</strong>
